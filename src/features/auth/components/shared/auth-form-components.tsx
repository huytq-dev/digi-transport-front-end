...
export function FormLabel({ htmlFor, hasError, required = false, children }: FormLabelProps) {
  return (
    <Label htmlFor={htmlFor} className={cn(LABEL_CLASSES, hasError && "text-red-500")}>
      {children}
    ...
    <div className="grid grid-cols-2 gap-4">
      <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.95 }}>
        <Button
          ...
          type="button"
          disabled={isLoading}
          className="w-full h-11 rounded-xl border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-colors shadow-sm"
      ...
      <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.95 }}>
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
          >
            <path d="M9.19795 21.5H13.198V13.4901H16.8021L17.198 9.50977H13.198V7.5C13.198 6.94772 13.6457 6.5 14.198 6.5H17.198V2.5H14.198C11.4365 2.5 9.19795 4.73858 9.19795 7.5V9.50977H7.19795L7.19795 13.4901H9.19795V21.5Z" />
          </svg>
          Facebook
        </Button>
      </motion.div>
